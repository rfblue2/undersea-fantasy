...
local function onPlayBtnRelease()
	...
	composer.gotoScene( "sea-1.sea-1-spawn", "fade", 500 )
...
function scene:create( event )
	...
	local titleLogo = display.newImageRect( "assets/img/logo.png", 264, 42 )
	...
	playBtn.x = screen.centerX
	playBtn.y = screen.bottom - 125
